		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Governance Cockpit-Accounts Operations",
									"targetURL": "#comhclaccountsoperations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhclaccountsoperations-display": {
								"semanticObject": "comhclaccountsoperations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hcl.accountsoperations",
									"url": sap.ui.require.toUrl("com/hcl/accountsoperations")
								}
							}
						}
					}
